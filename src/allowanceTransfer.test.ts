        ...
        AllowanceTransfer.hash(
          {
            details: {
              ...
              amount: '0',
              expiration: '0',
              nonce: (MaxOrderedNonce + 1n).toString(),
            },
            spender: '0x0000000000000000000000000000000000000000',
            sigDeadline: '0',
          },
        ...
        AllowanceTransfer.hash(
          {
            details: {
              token: '0x0000000000000000000000000000000000000000',
              amount: (MaxAllowanceTransferAmount + 1n).toString(),
              expiration: '0',
              nonce: 0,
            },
            spender: '0x0000000000000000000000000000000000000000',
        ...
        AllowanceTransfer.hash(
          {
            details: {
              token: '0x0000000000000000000000000000000000000000',
              amount: '0',
              expiration: (MaxAllowanceExpiration + 1n).toString(),
              nonce: 0,
            },
            spender: '0x0000000000000000000000000000000000000000',
            sigDeadline: '0',
        ...
        AllowanceTransfer.hash(
          {
            ...
            spender: '0x0000000000000000000000000000000000000000',
            sigDeadline: (MaxSigDeadline + 1n).toString(),
          },
          '0x0000000000000000000000000000000000000000',
          1
        )
